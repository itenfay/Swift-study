...
class ExtensionsUsage: NSObject {
    ...
    func execute() {
        ...
        var someInt = 3
        print("Now someInt is \(someInt.square())")
        ...
        //746381295[8]
        // 返回 7
        print("index 0 of 746381295 is \(746381295[0])")
        print("index 1 of 746381295 is \(746381295[1])")
        print("index 2 of 746381295 is \(746381295[2])")
        print("index 8 of 746381295 is \(746381295[8])")
        //如果该 Int 值没有足够的位数，即下标越界，那么上述下标实现会返回 0，犹如在数字左边自动补 0：
        print("index 9 of 746381295 is \(746381295[9])")
