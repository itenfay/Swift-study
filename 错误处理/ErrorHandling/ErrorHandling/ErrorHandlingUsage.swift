...
func buyFavoriteSnack(person: String, vendignMachine: VendingMachine) throws {
    let snackName = favoriteSnacks[person] ?? "Candy Bar"
    try vendignMachine.vend(itemNamed: snackName)
}
...
class ErrorHandlingUsage: NSObject {
    ...
    func execute() {
        ...
        do {
            try buyFavoriteSnack(person: "Alice", vendignMachine: vendingMachine)
